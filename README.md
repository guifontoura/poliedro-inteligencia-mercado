...
- `data/outputs/14_escolas_powerbi.csv` — as 965 Golden Leads prontas pro Power BI, com cidade/UF/segmento/score, bairro, renda mediana do responsável (IBGE Censo 2022) + categoria legível, sistema de ensino identificado (pesquisa manual, crescente) e `distrito` (real em São Paulo; Região Administrativa oficial no Rio de Janeiro, revisão 24/07 — ver `granularidade_geo`).
