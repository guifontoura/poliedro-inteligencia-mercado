...
- `data/outputs/14_escolas_powerbi.csv` — as 1.127 Golden Leads prontas pro Power BI, com cidade/UF/segmento/score (3 casas decimais), bairro, renda mediana do responsável (IBGE Censo 2022) + categoria legível, sistema de ensino identificado (**concluído em 24/07 — 100% das 1.127 pesquisadas**, 31 delas já clientes do próprio Sistema Poliedro sob marcas diferentes — ver `SISTEMA_ENSINO_METODOLOGIA.md`) e `distrito` (real em São Paulo; Região Administrativa oficial no Rio de Janeiro, revisão 24/07 — ver `granularidade_geo`).
...
**3.0, Identificação de sistema de ensino já em uso** (concluído em 24/07 — 100% das 1.127 Golden Leads): metodologia completa, achados de clientes ocultos do Poliedro e limitações documentadas em `SISTEMA_ENSINO_METODOLOGIA.md`.
